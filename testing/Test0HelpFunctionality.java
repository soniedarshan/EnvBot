...
public class Test0HelpFunctionality
{
	...
	public void checkHelpFunctionality()
	{
		...
		WebElement msg = driver.findElement(
				By.xpath("(//span[@class='message_body']/div[@class='attachment_pretext for_attachment_group' and text() = 'Hello '])[last()]"));
		assertNotNull(msg);
		assertEquals("Hello @" + myUserName + ", how may I be of help? Go to this link to check out the list of commands!", msg.getText());
	}
