...
public class Test1InvalidDockerFile
{
	...
	public void checkTest()
	{
		...
		WebElement msg = driver.findElement(
				By.xpath("(//a[@href='/team/testbot' and text() = 'testbot']/../span[@class='message_body' and text() = ', Can I have a valid URL(i.e., belonging to a GitHub repository)?'])[last()]"));
		
		
		assertNotNull(msg);
		assertEquals("@" + myUserName + ", Can I have a valid URL(i.e., belonging to a GitHub repository)?", msg.getText());
	}
}