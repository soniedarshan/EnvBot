...
public class Test2BlankStackCom
{
	...
	public void checkTest()
	{
		...
		messageBot.sendKeys("request docker image");
		messageBot.sendKeys(Keys.RETURN);
		
		wait.withTimeout(3, TimeUnit.SECONDS).ignoring(StaleElementReferenceException.class);
		
		WebElement msg = driver.findElement(
				By.xpath("(//a[@href='/team/testbot' and text() = 'testbot']/../span[@class='message_body']/div[@class='attachment_pretext for_attachment_group' and text() = 'Available Docker Images'])[last()]"));
		
		
		assertNotNull(msg);
		assertEquals("Available Docker Images", msg.getText());
	}
}