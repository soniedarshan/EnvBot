...
public class Test2InvalidStackCom
{
	...
	public void checkTest()
	{
		...
		WebElement msg = driver.findElement(
				By.xpath("(//a[@href='/team/testbot' and text() = 'testbot']/../span[@class='message_body']/div[@class='attachment_pretext for_attachment_group' and text() = 'Sorry. Docker image unavailable.'])[last()]"));
		
		
		assertNotNull(msg);
		assertEquals("Sorry. Docker image unavailable.", msg.getText());
	}
}