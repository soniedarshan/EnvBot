...
public class Test2ValidStackCom
{
	...
	public void checkTest()
	{
		...
		messageBot.sendKeys("request docker image python");
		messageBot.sendKeys(Keys.RETURN);
		
		wait.withTimeout(3, TimeUnit.SECONDS).ignoring(StaleElementReferenceException.class);
		
		WebElement msg = driver.findElement(
				By.xpath("(//a[@href='/team/testbot' and text() = 'testbot']/../span[@class='message_body']/div[@class='attachment_pretext for_attachment_group' and text() = 'You can enter the following commands to setup the docker image:'])[last()]"));
		
		
		assertNotNull(msg);
		assertEquals("You can enter the following commands to setup the docker image:", msg.getText());
	}
}