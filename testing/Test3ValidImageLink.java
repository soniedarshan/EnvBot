...
public class Test3ValidImageLink
{
	...
	public void checkTest()
	{
		...
		messageBot.sendKeys("docker image https://github.com/alt-code/DockerizeMe");
		messageBot.sendKeys(Keys.RETURN);
		
		wait.withTimeout(3, TimeUnit.SECONDS).ignoring(StaleElementReferenceException.class);
		
		WebElement msg = driver.findElement(
				By.xpath("(//a[@href='/team/testbot' and text() = 'testbot']/../span[@class='message_body' and text()='docker pull dockerBot/ + dockerizeMe'])[last()]"));
		
		
		assertNotNull(msg);
		assertEquals("docker pull dockerBot/ + dockerizeMe", msg.getText().trim());
	}
}